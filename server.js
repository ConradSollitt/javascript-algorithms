...
/**
 * Assume files without a type are JavaScript files
 * using [import File from './File'] statements.
 */
...
const server = http.createServer((req, res) => {
  ...
  // Add default file type if none was specified
  if (!reqPath.includes('.')) {
    reqPath += '.' + defaultFileType;
  }
